...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_img_size', type=int, default=608, help='input image size for yolo detector')

    parser.add_argument('--tracker_batch_size', type=int, default=6, help='batch size of object detector used for bbox tracking')

    parser.add_argument('--vibe_batch_size', type=int, default=20, help='batch size of VIBE')
